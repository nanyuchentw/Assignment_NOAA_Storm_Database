...
ggplot(p, aes(x=EVTYPE, y=Amount, fill=Type))+ geom_col(position="dodge")+
        labs(x= "Event type", y="Economic loss (dollars)" , title = "Top 10 events with the greatest economic impact")+
        coord_flip()
```
...
ggplot(p, aes(x= EVTYPE, y=Number, fill=Type))+ geom_col(position="dodge")+
        labs(x="Event type", y="Injuries (person)", title= "Top 10 events causing injuries/fatalities")+
        coord_flip()
